...
public class BiomeOrderBasin extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:order_basin")
    public static final BiomeGenCustom biome;
    
    public BiomeOrderBasin(final ElementsGctOresMod instance) {
        super(instance, 486);
    }
    ...
    static class BiomeGenCustom extends Biome
    {
        public BiomeGenCustom() {
            super(new Biome.BiomeProperties("Order Basin").setRainfall(0.0f).setBaseHeight(0.0f).setHeightVariation(1.0f).setTemperature(0.5f));
            this.setRegistryName("order_basin");
            this.topBlock = BlockOrderCobblestone.block.getDefaultState();
