...
import com.gmm.gctores.item.ItemDIM101;
...
public class WorldDIM101 extends ElementsGctOresMod.ModElement
{
    public static int DIMID;
    public static final boolean NETHER_TYPE = false;
    @GameRegistry.ObjectHolder("gct_ores:the_nowhere_portal")
    public static final BlockCustomPortal portal;
    public static DimensionType dtype;
    
    public WorldDIM101(final ElementsGctOresMod instance) {
        super(instance, 206);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> (Item)new ItemBlock((Block)WorldDIM101.portal).setRegistryName(WorldDIM101.portal.getRegistryName()));
        this.elements.items.add(() -> (Item)new ItemDIM101().setTranslationKey("the_nowhere").setRegistryName("the_nowhere"));
    }
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        ...
        WorldDIM101.dtype = DimensionType.register("the_nowhere", "_the_nowhere", WorldDIM101.DIMID, (Class)WorldProviderMod.class, true);
    ...
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemDIM101.block, 0, new ModelResourceLocation("gct_ores:the_nowhere", "inventory"));
    }
    
    static {
        WorldDIM101.DIMID = 101;
        portal = null;
    }
        ...
        public void onEntityCollision(final World worldIn, final BlockPos pos, final IBlockState state, final Entity entityIn) {
            if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
                ...
                if (thePlayer.timeUntilPortal > 0) {
                    ...
                    thePlayer.server.getPlayerList().transferPlayerToDimension(thePlayer, WorldDIM101.DIMID, (Teleporter)this.getTeleporterForDimension((Entity)thePlayer, pos, WorldDIM101.DIMID));
                }
                else {
                    thePlayer.timeUntilPortal = 10;
                    ReflectionHelper.setPrivateValue((Class)EntityPlayerMP.class, (Object)thePlayer, (Object)true, "invulnerableDimensionChange", "invulnerableDimensionChange");
    ...
    public static class GenLayerBiomesCustom extends GenLayer
    {
        ...
        public GenLayerBiomesCustom(final long seed) {
            super(seed);
            this.allowedBiomes = new Biome[] { (Biome)Biome.REGISTRY.getObject(new ResourceLocation("gct_ores:nowhere")) };
        }
