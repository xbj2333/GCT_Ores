...
public class StructureVoidBedrockRodTreasure extends ElementsGctOresMod.ModElement
{
    public StructureVoidBedrockRodTreasure(final ElementsGctOresMod instance) {
        super(instance, 365);
    }
            ...
            for (int count = random.nextInt(1) + 1, a = 0; a < count; ++a) {
                ...
                if (blockCriteria) {
                    ...
                    if (biomeCriteria) {
                        ...
                        final Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("gct_ores", "void_bdr_t"));
                        if (template == null) {
                            return;
                        }
