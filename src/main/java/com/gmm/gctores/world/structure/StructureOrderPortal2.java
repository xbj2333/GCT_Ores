...
public class StructureOrderPortal2 extends ElementsGctOresMod.ModElement
{
    public StructureOrderPortal2(final ElementsGctOresMod instance) {
        super(instance, 409);
    }
    ...
    public void generateWorld(final Random random, final int i2, final int k2, final World world, final int dimID, final IChunkGenerator cg, final IChunkProvider cp) {
        ...
        if (random.nextInt(1000000) + 1 <= 0) {
            for (int count = random.nextInt(1) + 1, a = 0; a < count; ++a) {
                ...
                final Mirror mirror = Mirror.NONE;
