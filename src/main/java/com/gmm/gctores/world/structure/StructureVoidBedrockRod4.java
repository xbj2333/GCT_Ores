...
public class StructureVoidBedrockRod4 extends ElementsGctOresMod.ModElement
{
    public StructureVoidBedrockRod4(final ElementsGctOresMod instance) {
        super(instance, 364);
    }
            ...
            for (int count = random.nextInt(1) + 1, a = 0; a < count; ++a) {
                ...
                if (blockCriteria) {
                    ...
                    if (biomeCriteria) {
                        ...
                        final Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("gct_ores", "void_bdr_4"));
                        if (template == null) {
                            return;
                        }
