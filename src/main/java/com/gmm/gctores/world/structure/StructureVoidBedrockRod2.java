...
public class StructureVoidBedrockRod2 extends ElementsGctOresMod.ModElement
{
    public StructureVoidBedrockRod2(final ElementsGctOresMod instance) {
        super(instance, 362);
    }
            ...
            for (int count = random.nextInt(1) + 1, a = 0; a < count; ++a) {
                ...
                if (blockCriteria) {
                    ...
                    if (biomeCriteria) {
                        ...
                        final Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("gct_ores", "void_bdr_2"));
                        if (template == null) {
                            return;
                        }
