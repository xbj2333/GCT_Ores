...
public class StructureVoidBedrockRod1 extends ElementsGctOresMod.ModElement
{
    public StructureVoidBedrockRod1(final ElementsGctOresMod instance) {
        super(instance, 361);
    }
            ...
            for (int count = random.nextInt(1) + 1, a = 0; a < count; ++a) {
                ...
                if (blockCriteria) {
                    ...
                    if (biomeCriteria) {
                        ...
                        final Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("gct_ores", "void_bdr_1"));
                        if (template == null) {
                            return;
                        }
