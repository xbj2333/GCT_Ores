...
public class BlockShalloiteSlab extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:shalloite_slab")
    public static final Block block;
    @GameRegistry.ObjectHolder("gct_ores:shalloite_slab_double")
    public static final Block block_slab_double;
    
    public BlockShalloiteSlab(final ElementsGctOresMod instance) {
        super(instance, 477);
    }
    
    @Override
    public void initElements() {
        this.elements.blocks.add(() -> (Block)new BlockCustom().setRegistryName("shalloite_slab"));
        this.elements.blocks.add(() -> (Block)new BlockCustom.Double().setRegistryName("shalloite_slab_double"));
        this.elements.items.add(() -> (Item)new ItemSlab(BlockShalloiteSlab.block, (BlockSlab)BlockShalloiteSlab.block, (BlockSlab)BlockShalloiteSlab.block_slab_double).setRegistryName(BlockShalloiteSlab.block.getRegistryName()));
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(BlockShalloiteSlab.block), 0, new ModelResourceLocation("gct_ores:shalloite_slab", "inventory"));
    }
    ...
    public static class BlockCustom extends BlockSlab
    {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            this.setTranslationKey("shalloite_slab");
        ...
        public Item getItemDropped(final IBlockState state, final Random rand, final int fortune) {
            return Item.getItemFromBlock(BlockShalloiteSlab.block);
        }
        
        public ItemStack getItem(final World worldIn, final BlockPos pos, final IBlockState state) {
            return new ItemStack(BlockShalloiteSlab.block);
        }
