...
public class BlockOrderStoneBrickCrashedSlab extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:order_stone_brick_crashed_slab")
    public static final Block block;
    @GameRegistry.ObjectHolder("gct_ores:order_stone_brick_crashed_slab_double")
    public static final Block block_slab_double;
    
    public BlockOrderStoneBrickCrashedSlab(final ElementsGctOresMod instance) {
        super(instance, 166);
    }
    
    @Override
    public void initElements() {
        this.elements.blocks.add(() -> (Block)new BlockCustom().setRegistryName("order_stone_brick_crashed_slab"));
        this.elements.blocks.add(() -> (Block)new BlockCustom.Double().setRegistryName("order_stone_brick_crashed_slab_double"));
        this.elements.items.add(() -> (Item)new ItemSlab(BlockOrderStoneBrickCrashedSlab.block, (BlockSlab)BlockOrderStoneBrickCrashedSlab.block, (BlockSlab)BlockOrderStoneBrickCrashedSlab.block_slab_double).setRegistryName(BlockOrderStoneBrickCrashedSlab.block.getRegistryName()));
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(BlockOrderStoneBrickCrashedSlab.block), 0, new ModelResourceLocation("gct_ores:order_stone_brick_crashed_slab", "inventory"));
    }
    ...
    public static class BlockCustom extends BlockSlab
    {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            this.setTranslationKey("order_stone_brick_crashed_slab");
        ...
        public Item getItemDropped(final IBlockState state, final Random rand, final int fortune) {
            return Item.getItemFromBlock(BlockOrderStoneBrickCrashedSlab.block);
        }
        
        public ItemStack getItem(final World worldIn, final BlockPos pos, final IBlockState state) {
            return new ItemStack(BlockOrderStoneBrickCrashedSlab.block);
        }
