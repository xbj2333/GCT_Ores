...
public class BlockFinalliumContainerActive extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:finallium_container_active")
    public static final Block block;
    
    public BlockFinalliumContainerActive(final ElementsGctOresMod instance) {
        super(instance, 494);
    }
    
    @Override
    public void initElements() {
        this.elements.blocks.add(() -> (Block)new BlockCustom().setRegistryName("finallium_container_active"));
        this.elements.items.add(() -> (Item)new ItemBlock(BlockFinalliumContainerActive.block).setRegistryName(BlockFinalliumContainerActive.block.getRegistryName()));
    }
    
    @Override
    public void init(final FMLInitializationEvent event) {
        GameRegistry.registerTileEntity((Class)TileEntityCustom.class, "gct_ores:tileentityfinallium_container_active");
    }
    
    @SideOnly(Side.CLIENT)
    @Override
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(BlockFinalliumContainerActive.block), 0, new ModelResourceLocation("gct_ores:finallium_container_active", "inventory"));
    }
    ...
    public static class BlockCustom extends Block implements ITileEntityProvider
    {
        public BlockCustom() {
            super(Material.IRON);
            this.setTranslationKey("finallium_container_active");
        ...
        public void getDrops(final NonNullList<ItemStack> drops, final IBlockAccess world, final BlockPos pos, final IBlockState state, final int fortune) {
            drops.add(new ItemStack(BlockFinalliumContainer.block, 1));
        }
    ...
    public static class TileEntityCustom extends TileEntityLockableLoot
    {
        ...
        public String getName() {
            return "container.finallium_container_active";
        }
        ...
        public String getGuiID() {
            return "gct_ores:finallium_container_active";
        }
