...
public class ItemGeniteIngot extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:genite_ingot")
    public static final Item block;
    
    public ItemGeniteIngot(final ElementsGctOresMod instance) {
        super(instance, 8);
    }
    ...
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemGeniteIngot.block, 0, new ModelResourceLocation("gct_ores:genite_ingot", "inventory"));
    }
