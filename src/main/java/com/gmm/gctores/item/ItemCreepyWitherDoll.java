...
import com.gmm.gctores.procedure.ProcedureCreepyWitherDollClick;
...
public class ItemCreepyWitherDoll extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:creepy_wither_doll")
    public static final Item block;
    
    public ItemCreepyWitherDoll(final ElementsGctOresMod instance) {
        super(instance, 156);
    }
    ...
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemCreepyWitherDoll.block, 0, new ModelResourceLocation("gct_ores:creepy_wither_doll", "inventory"));
    }
