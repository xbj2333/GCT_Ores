...
public class ItemEveriteIngot extends ElementsGctOresMod.ModElement
{
    @GameRegistry.ObjectHolder("gct_ores:everite_ingot")
    public static final Item block;
    
    public ItemEveriteIngot(final ElementsGctOresMod instance) {
        super(instance, 7);
    }
    ...
    public void registerModels(final ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(ItemEveriteIngot.block, 0, new ModelResourceLocation("gct_ores:everite_ingot", "inventory"));
    }
