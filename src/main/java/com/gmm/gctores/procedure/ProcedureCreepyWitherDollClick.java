...
public class ProcedureCreepyWitherDollClick extends ElementsGctOresMod.ModElement
{
    public ProcedureCreepyWitherDollClick(final ElementsGctOresMod instance) {
        super(instance, 366);
    }
    
    public static void executeProcedure(final Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            System.err.println("Failed to load dependency entity for procedure CreepyWitherDollClick!");
            return;
        }
        if (dependencies.get("x") == null) {
            System.err.println("Failed to load dependency x for procedure CreepyWitherDollClick!");
            return;
        }
        if (dependencies.get("y") == null) {
            System.err.println("Failed to load dependency y for procedure CreepyWitherDollClick!");
            return;
        }
        if (dependencies.get("z") == null) {
            System.err.println("Failed to load dependency z for procedure CreepyWitherDollClick!");
            return;
        }
        if (dependencies.get("world") == null) {
            System.err.println("Failed to load dependency world for procedure CreepyWitherDollClick!");
            return;
        }
        ...
        if (entity.dimension == 1 && x == 0 && z == 0) {
            ...
            if (!_ent.world.isRemote && !_ent.isRiding() && !_ent.isBeingRidden() && _ent instanceof EntityPlayerMP) {
                final int dimensionID = WorldDIM100.DIMID;
        ...
        else if (entity.dimension == WorldDIM100.DIMID) {
            final Entity _ent = entity;
            if (!_ent.world.isRemote && !_ent.isRiding() && !_ent.isBeingRidden() && _ent instanceof EntityPlayerMP) {
        ...
        else if (entity.dimension != 1 && entity.dimension != WorldDIM100.DIMID) {
            if (!world.isRemote && world.getMinecraftServer() != null) {
                ...
                }, "tellraw @p[r=32] [\"\",{\"text\":\"\u53ef\u6015\u7684\u51cb\u7075\u73a9\u5076\uff1a\u6211\u8c8c\u4f3c\u4e0d\u80fd\u5728\u8fd9\u4e2a\u7ef4\u5ea6\u65bd\u5c55\u80fd\u529b\u2026\u2026\"}] ");
            }
        }
            ...
            }, "tellraw @p[r=32] [\"\",{\"text\":\"\u53ef\u6015\u7684\u51cb\u7075\u73a9\u5076\uff1a \u53ea\u6709\u6765\u5230\u4e86\u672b\u8def\u4e4b\u5730\u7684\u539f\u70b9\uff0c\u6211\u624d\u80fd\u65bd\u5c55\u80fd\u529b\uff01\"}] ");
        }
    }
}
